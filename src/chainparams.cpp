...
{
    const char* pszTimestamp = "Keep up with inflation using USDI coin 19/jan/2022";
...
public:
    CMainParams() {
        ...
        */
        ...
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000000010b66d1f9c7dd8d7");
