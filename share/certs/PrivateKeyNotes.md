...
unlocked to sign the Usdi-Qt.app bundle.
...
allowing somebody to distribute a Usdi-Qt.app or usdi-qt-setup.exe with a valid
...
that the usdi-qt.exe file inside the installer had not been tampered with.
